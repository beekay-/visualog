...
function addLightTheme() {
    ...
    $('body, #header, #header > .logo, #header > .description, #map-controls > .custom-select > select, #map-controls > .custom-select > .label').addClass('light');
...
function addDarkTheme() {
    ...
    $('body, #header, #header > .logo, #header > .description, #map-controls > .custom-select > select, #map-controls > .custom-select > .label').removeClass('light');
